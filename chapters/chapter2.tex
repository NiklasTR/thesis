...
% add a section on FAK theory and microtubuli
...
% include citations for off target
...
% cite https://pubmed.ncbi.nlm.nih.gov/20708155/
...
% TODO cite Fridman signature paper
% TODO check protoemics for factor 2 - notes suggest downregulation of telomer maintanance
...
% TODO lookup variaction explained
...
% cite BJ fibroblast paper https://pubs.rsc.org/en/content/articlelanding/2017/mb/c6mb00842a
% cite zebrafish paper.https://pubmed.ncbi.nlm.nih.gov/30065049/
...
\label{fig_300}
\end{figure}
% add and check details on Myc expression test
...
% add citation for mTORC1 preference

Further exploration of factor 3 loadings in gene expression space showed an enrichment for Myc target genes. Transcription signatures associated with increased Myc activity are enriched in double-mutant organoid models (Apc-/- KrasG12D+/-) when compared to single-mutant counterparts (Figure \ref{fig_300}d). In fact, further analysis of factor 1 and factor 2 gene expression loadings identified significant changes in Myc activity signatures for both factors as well. Simplified, loss of function of Apc led to an increased activity of Myc (factor 1) while the isolated presence of oncogenic KrasG12D+/- led to a reduced activity of Myc (factor 1: , factor 2: ,  ). These observations are consistent with previous studies describing a central role of increased Myc activity in Wnt-signaling dependent adenoma formation and decreased Myc activity in oncogene induced senescence.
%TODO add citation
%TODO add GSEA statistics for factor 1 and 2
%TODO add citation of japanese adenoma paper and zebrafish senescence

In summary, factor 3 is representing the interaction of Apc loss of function and oncogenic KrasG12D+/-. In the mouse colon organoid model, the introduction of oncogenic KrasG12D+/- within an Apc-/- background leads to an increased mTORC1 signaling related gene expression signature and increased sensitivity to small molecule mTOR inhibitors. Myc activity related gene expression is increased in all factors related to malignant transformation, except the introduction of oncogenic KrasG12D+/- in Apc+/+ organoids, where Myc activity is reduced. 
...
% TODO citation revertant genetic mutation
\begin{figure}[h]
\centering
\includegraphics[scale=0.75,
...
%modeling of ANOVA score ~ organoid + drug
