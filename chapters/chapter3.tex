...
\subsection{Factor 1 separates \textit{Apc}\textsuperscript{+/+} from \textit{Apc}\textsuperscript{-/-} organoids}
...
\subsection{Factor 2 separates \textit{Kras}\textsuperscript{G12D/+} organoids from \textit{Kras} wildtype models}
