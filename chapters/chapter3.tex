...
% actual text
A common challenge in phenotypic discovery experiments is navigating the trade-off between breadth and depth of information generated by an imaging experiment (i.e. custom pathway activity reporters and staining protocols vs. general purpose reagent, such as cell painting). If general morphology profiles are collected, such as in the image-based profiling experiments presented here, the annotation of treatment-induced morphologies is often limited to describing similarities among treatments (i.e. small molecules with the same mechanism of action show similar treatment-induced morphologies). In the previous chapter, it was observed that treatment-induced morphologies can also be used to identify similarities between treatments and well-characterised untreated states of organoid models to support the generation of hypotheses regarding their detailed mechanism of action. To retrieve these similarities, treatment-induced morphologies were projected into a lower dimensional factor space learnt through MOFA. To evaluate whether such an approach could be used in a therapeutic discovery scenario, I applied this approach to the treatmend-induced morphologies observed in the four genetically defined organoid models.  
\bigbreak
